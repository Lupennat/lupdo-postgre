...
describe('Postgres BigInt Cast', () => {
    ...
    it('Works All Columns Types', async () => {
        ...
        if (isCrdb()) {
            ...
            expect(row.double_precision).toBe(isRealPrecision() ? '0.123456789012346' : '0.12345678901234568');
            ...
            expect(row.real).toBe(isRealPrecision() ? '222221234.56686' : '2.2222123e+08');
    ...
    it('Works Array Types', async () => {
        ...
        if (isCrdb()) {
            ...
            expect(row.double_precision).toEqual(['1.2345678901234568e+18', '0.12345678901234568']);
            ...
            expect(row.real).toEqual(
                isRealPrecision() ? ['2.2222123456686e+08', '3.56686789'] : ['2.2222123e+08', '3.5668678']
            );
            ...
            expect(row.timetz).toEqual(
                supportArrayTime() ? ['04:05:06+01', '04:05:06-08'] : ['04:05:06+01:00:00', '04:05:06-08:00:00']
            );
